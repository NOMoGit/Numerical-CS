...
class Comsimpson extends React.Component {
    ...
    calculate = () => {
        try {
            ...
            console.log('Equation string from state:', equation); 
            console.log('Is nerdamer an object?', typeof nerdamer);
            console.log('Is nerdamer.integrate a function?', typeof nerdamer.integrate);
            if (!equation) {
                alert("กรุณาใส่สมการ");
                return;
            }
            ...
            const I_cal = this.comsimpsoncal(anum, bnum, nnum, variable);
                        ...
                        <div className="w-full bg-white rounded-2xl shadow-lg p-8 space-y-6">
                            ...
                            <div className="w-full mt-6 p-4 bg-white rounded-2xl shadow-md">
                                <Plot
                                    ...
                                    layout={{
                                        autosize: true,
                                        title: { text: "Conposite Simpson's Rule Approximation" },
                                        xaxis: { title: { text: "X" } },
